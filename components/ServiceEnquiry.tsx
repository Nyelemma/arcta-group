...
export default function ServiceEnquiry({
  title,
  description = "Free quotes returned within the hour. Tell us about your property and we'll take it from there.",
  ctaLabel,
  whatsappText,
}: ServiceEnquiryProps) {
  const waUrl = whatsappText
    ? `${business.whatsapp}?text=${encodeURIComponent(whatsappText)}`
    : business.whatsappMessage;

  return (
    <section className="relative overflow-hidden bg-mist-100 py-16 lg:py-20">
      <div className="container-x">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-navy-950 via-navy-900 to-royal-900 px-8 py-12 text-center shadow-card-lg sm:px-12 lg:py-14">
